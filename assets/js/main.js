...
document.addEventListener('DOMContentLoaded', function () {
    ...
    rail.innerHTML = [
        ...
        '<li class="site-contact-rail__item"><a href="https://www.instagram.com/hancockpublishers/" target="_blank" rel="noopener" class="site-contact-rail__link" aria-label="Instagram"><i class="fab fa-instagram" aria-hidden="true"></i><span>Instagram</span></a></li>',
        '<li class="site-contact-rail__item"><a href="https://www.facebook.com/hancockpublisher" target="_blank" rel="noopener" class="site-contact-rail__link" aria-label="Facebook"><i class="fab fa-facebook-f" aria-hidden="true"></i><span>Facebook</span></a></li>',
        '</ul>'
    ].join('');
